...
// Make the query:
$q = "SELECT ArticleHeadline, NewsArticleContent FROM NewsArticles ORDER BY ArticleID DESC";		
...
if ($num > 0) { // If it ran OK, display the records.
	...
	while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
		echo '<tr><td align="left"><h2>' . $row['ArticleHeadline'] . '</h2><br><br></td><td align="left"><p>' . $row['NewsArticleContent'] . '</p><br><br><br><br></td></tr>
		';
	}
