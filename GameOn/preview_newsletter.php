...
<title>GameOn Preview Newsletter</title>
...
$page_title = 'Preview Newsletter';


// Page header:
echo '<h1>Preview Newsletter</h1>';

require_once ('mysqli_connect.php'); // Connect to the db.
		
// Make the query:
$q = "SELECT title, description FROM newsletters ORDER BY newsletters_id DESC";		
...
if ($num > 0) { // If it ran OK, display the records.
	...
	echo "<p>There are currently $num Newsletters.</p>\n";


	
	// Fetch and print all the records:
	while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
		echo '<tr><td align="left"><h2>' . $row['title'] . '</h2><br><br></td><td align="left"><p>' . $row['description'] . '</p><br><br><br><br></td></tr>
		';
	}
	...
	echo '<p class="error">There are currently no Newsletters posted.</p>';
