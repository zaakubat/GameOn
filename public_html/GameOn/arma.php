...
<p style="font-size:350%;text-align:center;color:white"><b>ARMA 2 </b> <br> <img src="images/arma2.jpg" alt="arma" height="350" width="450"></p>

    <p style="font-size:120%;text-align:center;color:white">Platform:<nbsp> PC <br> Genre: FPS<br> Rating: 4/5 </p>
