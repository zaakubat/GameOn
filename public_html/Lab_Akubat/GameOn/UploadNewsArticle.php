...
<form action="UploadNewsArticle.php" method="post">
	<p>Article Headline: <input type="text" name="ArticleHeadline" size="50" maxlength="200" value="<?php if (isset($_POST['ArticleHeadline'])) echo $_POST['ArticleHeadline']; ?>" /></p>
	<p>News Article Content: <input type="text" size="50" maxlength="2000" name="NewsArticleContent" value="<?php if (isset($_POST['NewsArticleContent'])) echo $_POST['NewsArticleContent']; ?>" /></p>
